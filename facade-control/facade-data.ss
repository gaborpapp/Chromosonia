...
(define-struct side (name start-addr end-addr start-row end-row nr-columns double? addrs) #:prefab)

(define main-building-north
  #s(side 
	  "Main Building North"
	  0
	  119
...
(define main-building-south-street-level
  #s(side
